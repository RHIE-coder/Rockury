...
import { Table2, Eye as EyeIcon, Search, ChevronDown, ChevronRight, GitBranch, ShieldCheck } from 'lucide-react';
  ...
  return (
    <div className="flex h-full w-[200px] shrink-0 flex-col border-r border-border bg-background">
      ...
      {tab === 'tables' ? (
        ...
        <ConstraintList tables={tables} onSelect={onTableSelect} />
      )}
    </div>
  );
}
